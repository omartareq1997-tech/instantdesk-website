  ...
  switch (role) {
    case 'owner':
      return {
        ...
        canUndoActions: true, canManageAutomations: true, scopedToOwnLeads: false,
      }
    case 'team_leader':
      return {
        canAddLead: true, canEditLead: true, canDeleteLead: true,
    ...
    case 'agent':
      return {
        ...
        canUndoActions: false, canManageAutomations: false, scopedToOwnLeads: true,
      }
    case 'viewer':
      return {
        ...
        canInviteMember: false, canRemoveMember: false, canChangeRole: false,
        canUndoActions: false, canManageAutomations: false, scopedToOwnLeads: false,
      }
  }
}
